...
export default function VibratorAdjustScreen() {
  ...
  >
    <Text style={styles.title}>VIBRATOR ADJUST</Text>
    <View style={styles.row}>
        ...
        <View style={styles.subContainer2}>
            <Text style={styles.text2}>FV</Text>
        ...
        <View style={styles.subContainer2}>
            <Text style={styles.text2}>RV</Text>
            <TextInput style={styles.textInput} keyboardType='numeric' />
            <TextInput style={styles.textInput} keyboardType='numeric' />
            <TextInput style={styles.textInput} keyboardType='numeric' />
            <TextInput style={styles.textInput} keyboardType='numeric' />
